...
if (!isset($_GET['slug']) || empty($_GET['slug'])) {
    echo "Slug Berita tidak ditemukan.";
    exit;
}

$slug = mysqli_real_escape_string($connect, $_GET['slug']);
$query = "SELECT * FROM berita WHERE slug='$slug'";
...
<head>
    ...
    <title>Detail Berita - Mediatama</title>
                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid" src="../PELATIHAN_MEDIATAMA/admin/images/<?php echo htmlspecialchars($data['gambar_berita']); ?>" alt="">
                        </div>
                        <div class="blog_details">
                            <h2><?php echo htmlspecialchars($data['judul_berita']); ?></h2>
                            <ul class="blog-info-link mt-3 mb-4">
                                <li><a href="#"><i class="fa fa-user"></i> <?php echo htmlspecialchars($data['kategori_berita']); ?></a></li>
                                <li><a href="#"><i class="fa fa-comments"></i> 03 Comments</a></li>
                            </ul>
                            <p>
                                <?php echo htmlspecialchars($data['isi_berita']); ?>
                            </p>
                        </div>
                    </div>
