...
if (isset($_SESSION['pesan'])) {
    echo '<div class="alert alert-warning">' . $_SESSION['pesan'] . '</div>';
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="proses_edit_kategori.php?id_kategori=<?php echo htmlspecialchars($id_kategori); ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="nama_kategori_berita">Nama Kategori</label>
                                    <input type="text" class="form-control" id="nama_kategori_berita" name="nama_kategori_berita" value="<?php echo htmlspecialchars($data['nama_kategori_berita']); ?>">
                                </div>
