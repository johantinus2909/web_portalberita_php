                        ...
                        <div class="card-body">
                            <form action="proses_tambah_kategori.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="nama_kategori_berita">Judul Berita</label>
                                    <input type="text" class="form-control" id="nama_kategori_berita" name="nama_kategori_berita" required="">
                                </div>
