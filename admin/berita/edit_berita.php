...
<body>
                    ...
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="base">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="../kategori/tampil_kategori.html">
                                            <span class="sub-item">Kategori</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="../berita/tampil_berita.html">
    ...
    <div class="card-body">
        <form action="proses_edit.php?id_berita=<?php echo htmlspecialchars($id_berita); ?>" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <label for="judul_berita">Judul Berita</label>
                <input type="text" class="form-control" id="judul_berita" name="judul_berita" value="<?php echo htmlspecialchars($data['judul_berita']); ?>">
            </div>
            <div class="form-group">
                <label for="isi_berita">Isi Berita</label>
                <textarea class="form-control" id="isi_berita" name="isi_berita" rows="5"><?php echo htmlspecialchars($data['isi_berita']); ?></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?php echo htmlspecialchars($data['tgl_berita']); ?>">
            </div>
            <div class="form-group">
